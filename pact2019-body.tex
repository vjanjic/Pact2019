...
\end{itemize}
The end product of software restoration is a structured parallel applications, written using parallel patterns. During the process of the restoration, the original legacy-parallel code goes through different transformation phases, as depicted in the Figure~\ref{fig:SoftRest}. This involves the following steps: 
